...
export interface DashboardFilters {
  ...
  startDate: Date;
  endDate: Date;
  /** Pass the service-role admin client for server-side jobs (e.g. the
   * scheduled-reports cron) that run with no user session to derive RLS
   * from. Defaults to the cookie-based user client. */
