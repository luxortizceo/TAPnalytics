      ...
      <Card>
        ...
        <CardContent className="flex flex-col gap-4">
          ...
          <p className="border-t border-border pt-4 text-xs text-muted-foreground">
            Más tipos de alerta (racha de quejas, problema recurrente, tarjeta sin actividad) se
            habilitan en la Fase 4 junto con TAP Intelligence, que necesita analizar tendencias en
            el tiempo.
          </p>
        </CardContent>
      </Card>
