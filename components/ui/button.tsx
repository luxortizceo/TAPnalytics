...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 shrink-0",
  {
    variants: {
      variant: {
        default: "bg-accent-solid text-accent-foreground hover:bg-[var(--color-racing-red-700)]",
        secondary:
        ...
        destructive: "bg-accent-solid text-accent-foreground hover:bg-[var(--color-racing-red-700)]",
      },
      size: {
        sm: "h-9 px-3 text-sm",
        md: "h-11 px-5",
